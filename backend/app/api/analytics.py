"""Analytics API router — full implementation."""
...
@router.get(
    "/summary",
    response_model=AnalyticsSummaryResponse,
    summary="Analytics summary (alias)",
    include_in_schema=False,
)
async def get_analytics_summary(db: AsyncSession = Depends(get_db)) -> AnalyticsSummaryResponse:
    ...
    # p95 total time via percentile_cont (PostgreSQL)
    try:
